...
import com.example.springbootinit.manager.AiManager;
import com.example.springbootinit.manager.RedisLimiterManager;
...
import com.example.springbootinit.model.vo.BiResponse;
...
import com.example.springbootinit.bizmq.BiMessageProducer;
import com.example.springbootinit.model.dto.chart.*;
...
//        List<String> tags = chartAddRequest.getId();
//        if (tags != null) {
...
//        }
    ...
    public BaseResponse<BiResponse> genChartByAiAsync(@RequestPart("file") MultipartFile multipartFile,
        ...
        String originalFilename = multipartFile.getOriginalFilename();//文件名称包括后缀
        // 校验文件大小
        final long ONE_MB = 1024 * 1024L;
        ThrowUtils.throwIf(size > ONE_MB, ErrorCode.PARAMS_ERROR, "文件超过 1M");
        // 校验文件后缀 aaa.png
